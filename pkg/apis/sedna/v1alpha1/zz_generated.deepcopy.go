...
func (in *AIClasses) DeepCopyInto(out *AIClasses) {
	*out = *in
	if in.ListOfAIClasses != nil {
		in, out := &in.ListOfAIClasses, &out.ListOfAIClasses
...
func (in *AIModels) DeepCopyInto(out *AIModels) {
	*out = *in
	if in.ListOfAIModels != nil {
		in, out := &in.ListOfAIModels, &out.ListOfAIModels
...
func (in *EvalSpec) DeepCopyInto(out *EvalSpec) {
	*out = *in
	if in.InitialModel != nil {
		in, out := &in.InitialModel, &out.InitialModel
		*out = new(InitialEvalModel)
		**out = **in
	}
	in.Template.DeepCopyInto(&out.Template)
	return
...
func (in *FeatureExtractionService) DeepCopy() *FeatureExtractionService {
	if in == nil {
		return nil
	}
	out := new(FeatureExtractionService)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureExtractionServiceCondition) DeepCopyInto(out *FeatureExtractionServiceCondition) {
	*out = *in
	in.LastHeartbeatTime.DeepCopyInto(&out.LastHeartbeatTime)
...
func (in *FeatureExtractionServiceCondition) DeepCopy() *FeatureExtractionServiceCondition {
	if in == nil {
		return nil
	}
	out := new(FeatureExtractionServiceCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureExtractionServiceList) DeepCopyInto(out *FeatureExtractionServiceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]FeatureExtractionService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FeatureExtractionServiceList) DeepCopy() *FeatureExtractionServiceList {
	if in == nil {
		return nil
	}
	out := new(FeatureExtractionServiceList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureExtractionServiceSpec) DeepCopyInto(out *FeatureExtractionServiceSpec) {
	*out = *in
	out.Model = in.Model
...
func (in *FeatureExtractionServiceSpec) DeepCopy() *FeatureExtractionServiceSpec {
	if in == nil {
		return nil
	}
	out := new(FeatureExtractionServiceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureExtractionServiceStatus) DeepCopyInto(out *FeatureExtractionServiceStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]FeatureExtractionServiceCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FeatureExtractionServiceStatus) DeepCopy() *FeatureExtractionServiceStatus {
	if in == nil {
		return nil
	}
	out := new(FeatureExtractionServiceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JointMultiEdgeService) DeepCopy() *JointMultiEdgeService {
	if in == nil {
		return nil
	}
	out := new(JointMultiEdgeService)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JointMultiEdgeServiceCondition) DeepCopyInto(out *JointMultiEdgeServiceCondition) {
	*out = *in
	in.LastHeartbeatTime.DeepCopyInto(&out.LastHeartbeatTime)
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
...
func (in *JointMultiEdgeServiceCondition) DeepCopy() *JointMultiEdgeServiceCondition {
	if in == nil {
		return nil
	}
	out := new(JointMultiEdgeServiceCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JointMultiEdgeServiceList) DeepCopyInto(out *JointMultiEdgeServiceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]JointMultiEdgeService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *JointMultiEdgeServiceList) DeepCopy() *JointMultiEdgeServiceList {
	if in == nil {
		return nil
	}
	out := new(JointMultiEdgeServiceList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JointMultiEdgeServiceSpec) DeepCopyInto(out *JointMultiEdgeServiceSpec) {
	*out = *in
	in.EdgeWorker.DeepCopyInto(&out.EdgeWorker)
	in.CloudWorker.DeepCopyInto(&out.CloudWorker)
	return
...
func (in *JointMultiEdgeServiceSpec) DeepCopy() *JointMultiEdgeServiceSpec {
	if in == nil {
		return nil
	}
	out := new(JointMultiEdgeServiceSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JointMultiEdgeServiceStatus) DeepCopyInto(out *JointMultiEdgeServiceStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]JointMultiEdgeServiceCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *JointMultiEdgeServiceStatus) DeepCopy() *JointMultiEdgeServiceStatus {
	if in == nil {
		return nil
	}
	out := new(JointMultiEdgeServiceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KnowledgeBase) DeepCopyInto(out *KnowledgeBase) {
	*out = *in
	in.AIModels.DeepCopyInto(&out.AIModels)
	in.AIClasses.DeepCopyInto(&out.AIClasses)
...
func (in *LLJobStatus) DeepCopyInto(out *LLJobStatus) {
	*out = *in
	...
	in.KnowledgeBase.DeepCopyInto(&out.KnowledgeBase)
	if in.StartTime != nil {
		in, out := &in.StartTime, &out.StartTime
		*out = (*in).DeepCopy()
	}
...
func (in *LifelongLearningJobList) DeepCopyInto(out *LifelongLearningJobList) {
	*out = *in
	...
	out.OverallKBStatus = in.OverallKBStatus
	in.OverallKBDetails.DeepCopyInto(&out.OverallKBDetails)
	return
}
...
func (in *ReidJobStatus) DeepCopyInto(out *ReidJobStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]ReidJobCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VideoAnalyticsJobCondition) DeepCopyInto(out *VideoAnalyticsJobCondition) {
	*out = *in
	in.LastHeartbeatTime.DeepCopyInto(&out.LastHeartbeatTime)
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
...
func (in *VideoAnalyticsJobCondition) DeepCopy() *VideoAnalyticsJobCondition {
	if in == nil {
		return nil
	}
	out := new(VideoAnalyticsJobCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VideoAnalyticsJobList) DeepCopyInto(out *VideoAnalyticsJobList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VideoAnalyticsJob, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VideoAnalyticsJobList) DeepCopy() *VideoAnalyticsJobList {
	if in == nil {
		return nil
	}
	out := new(VideoAnalyticsJobList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VideoAnalyticsJobSpec) DeepCopy() *VideoAnalyticsJobSpec {
	if in == nil {
		return nil
	}
	out := new(VideoAnalyticsJobSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VideoAnalyticsJobStatus) DeepCopyInto(out *VideoAnalyticsJobStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]VideoAnalyticsJobCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VideoAnalyticsJobStatus) DeepCopy() *VideoAnalyticsJobStatus {
	if in == nil {
		return nil
	}
	out := new(VideoAnalyticsJobStatus)
	in.DeepCopyInto(out)
	return out
}
