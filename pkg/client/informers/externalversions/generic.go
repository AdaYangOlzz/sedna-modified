...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("jointmultiedgeservices"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Sedna().V1alpha1().JointMultiEdgeServices().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("objectsearchservices"):
